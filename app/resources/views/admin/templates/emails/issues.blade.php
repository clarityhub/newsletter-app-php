																...
																<tbody>
																	<tr>
																		<td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
																			...
																			<img align="center" alt="" src="https://gallery.mailchimp.com/7da525c17c8d5399e087120fd/images/5f6fe5f8-5f95-489d-a195-e2c0fd67d180.png"
																			 width="408" style="max-width:816px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
																	...
																	<tr>
																		...
																		<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																			...
																			<h3 class="null" style="text-align: center;">
																				<br> Clarity Hub Weekly</h3>
																			&nbsp;

																			<div style="text-align: center;">Your weekly dose of hot open-source issues
																			that you can contribute to
																				<br> by
																				<a href="https://www.clarityhub.io/" target="_blank">Clarity Hub</a>
																				<br> &nbsp;
																			</div>
                                                        ...
                                                        <tr>
                                                            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="left" class="mcnButtonBlockInner">
																<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock" style="min-width:100%;">
																	<tbody class="mcnButtonBlockOuter">
																		<tr>
																			<td style="padding-top:0; padding-right:18px; padding-bottom:28px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
																				@if ($section['repo_description'])
																				...
																				<table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;background-color: #ED5A2E;">
																					<tbody>
																						<tr>
																							<td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 20px;">
																								<a class="mcnButton " title="{{$section['link_text']}}" href="{{$section['link_url']}}" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF; text-align:center">{{$section['link_text']}}
																								</a>
																							</td>
																						</tr>
																					</tbody>
																				...
																				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonBlock" style="min-width:100%;">
																					<tbody class="mcnButtonBlockOuter">
																						<tr>
																							<td style="border-bottom: 1px solid #EFEFEF; padding-top:18px; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="left" class="mcnButtonBlockInner">
																							</td>
																						</tr>
																					</tbody>
																				</table>
																...
																<tbody>
																	<tr>
																		...
																		<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																			...
																			<div style="text-align: center;">
																				<span style="font-size:14px">If you have any feedback or want to get in touch, just hit reply. We'll get back to you as soon as we
																					can.</span>
																			</div>
																																				...
																																				<tbody>
																																					<tr>
																																						...
																																						<td align="center" valign="middle" width="24" class="mcnFollowIconContent">
																																							<a href="http://www.facebook.com/clarityhubinc" target="_blank">
																																			...
																																			<table align="left" border="0" cellpadding="0" cellspacing="0" width="">
																																				<tbody>
																																					<tr>
																																						...
																																						<td align="center" valign="middle" width="24" class="mcnFollowIconContent">
																																							<a href="http://www.twitter.com/clarityhubinc" target="_blank">
																																			...
																																			<table align="left" border="0" cellpadding="0" cellspacing="0" width="">
																																				<tbody>
																																					<tr>
																																						...
																																						<td align="center" valign="middle" width="24" class="mcnFollowIconContent">
																																							<a href="https://www.linkedin.com/company/clarityhubinc/" target="_blank">
																																			...
																																			<table align="left" border="0" cellpadding="0" cellspacing="0" width="">
																																				<tbody>
																																					<tr>
																																						...
																																						<td align="center" valign="middle" width="24" class="mcnFollowIconContent">
																																							<a href="clarityhub.io" target="_blank">
